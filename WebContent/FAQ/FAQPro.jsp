...
<h1>질문게시판</h1>
<hr>
<form method="post" action="FSuccess.jsp"> 
...
<input class="bdbtn" type="submit" value="등록" onclick="location.href='FSuccess.jsp'">
<input class="bdbtn" type="button" value="목록" onclick="location.href='FAQForm.jsp'">
</div>
</center>
