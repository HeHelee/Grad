...
<input type = "submit"  class = "bdbtn" value = "로그아웃" onclick="javascript: form.action = 'Calling.jsp';">
&nbsp;<input type = "submit"  class = "bdbtn" value = "마이페이지" onclick="javascript: form.action = 'MypageForm.jsp';"> </h1>
<hr>
</center>
&nbsp;[ 기본 서비스 ]
...
if(id.equals("admin1")){
	%>
	  <input type = "submit" class = "bdbtn" value = "15.회원목록조회" onclick="javascript: form.action = '../Login/list.jsp';">
	<% 
}
%>
